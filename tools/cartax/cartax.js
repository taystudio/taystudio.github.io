 ...
 * - 승합·화물 5%: 지방세법 제12조
 * - 전기·수소차 감면 한도 140만원: 조세특례제한법 제66조의4 (2025년 말 일몰 예정 → 2026년 연장 여부 확인 필요)
 * - 하이브리드차 감면 한도 40만원: 조세특례제한법 제66조의4
...
document.getElementById("form").addEventListener("submit", (e) => {
  ...
  else if (type === "hybrid") { rate = 0.07; ecoDiscount = 400000; name = "하이브리드차"; }
